...
set_target_properties(OpenCL::UtilsCpp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenCLUtilsCpp.so"
  IMPORTED_SONAME_RELEASE "libOpenCLUtilsCpp.so"
  )

list(APPEND _cmake_import_check_targets OpenCL::UtilsCpp )
list(APPEND _cmake_import_check_files_for_OpenCL::UtilsCpp "${_IMPORT_PREFIX}/lib/libOpenCLUtilsCpp.so" )
